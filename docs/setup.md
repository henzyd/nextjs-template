...
| --------------------------------- | ----------- | ------------------------------------------------ |
| `APP_VARIANT`                     | Build/CLI   | Selects an application; defaults to the root app |
...
| Area                   | Required setup                                                                                                                                             |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Application topology   | Keep the root single app unless independent deployments need overlapping route trees; if so, follow the multi-tenant guide and name every tenant.          |
